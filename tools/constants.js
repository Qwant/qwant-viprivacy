...
export const ADGUARD_FILTERS_IDS = [16, 113, 3, 10, 15, 17, 118, 122, 207, 208, 4, 14, 201, 225, 239];
export const FILTER_DOWNLOAD_URL_FORMAT = 'https://f.qwant.com/tracking-protection/%browser_filter_%filter.txt';
