    ...
    return (
        <Box className={Styles.IconShield} {...props}>
            <svg width="60" height="68" viewBox="0 0 60 68" xmlns="http://www.w3.org/2000/svg">
                ...
                {count === false && <path d="M22.707 23.293a1 1 0 0 0-1.414 1.414L28.586 32l-7.293 7.293a1 1 0 1 0 1.414 1.414L30 33.414l7.293 7.293a1 1 0 1 0 1.414-1.414L31.414 32l7.293-7.293a1 1 0 0 0-1.414-1.414L30 30.586l-7.293-7.293z" fill={`var(--${color}-500)`} />}
            </svg>
            <Text typo="heading-1" bold center className={Styles.IconShieldCount}>{count > 99 ? '99+' : count}</Text>
        </Box>
    );
}
