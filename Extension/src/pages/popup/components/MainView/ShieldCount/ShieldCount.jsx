    ...
    return (
        <Box className={cx(Styles.IconShield, className)} {...props}>
            <svg width="60" height="68" viewBox="0 0 60 68" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M30 2c.997 0 1.994.16 2.952.478L51.618 8.69A9.319 9.319 0 0 1 58 17.53v16.577c0 17.088-17.298 27.46-24.702 31.118a7.438 7.438 0 0 1-3.297.775z" fill={`var(--${color}-200)`} />
            ...
            <Text typo={count > 99 ? 'heading-5' : 'heading-2'} bold center className={Styles.IconShieldCount}>{count > 99 ? '99+' : count}</Text>
        </Box>
    );
}
